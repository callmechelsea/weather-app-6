    ...
    function renderPage() {
      ...
      for (i = 0; i < storedCityArray.length; i++) {
        ...
        var queryURL =
          ...
          storedCityArray[0] +
          "&units=imperial&APPID=03f72f8c02de3787c1292588066d019a";
        ...
        $.ajax({
          ...
          var lanLonURL =
            ...
            "&lon=" +
            lon +
            "&appid=03f72f8c02de3787c1292588066d019a";
          ...
          var fiveDayURL =
            ...
            "&lon=" +
            lon +
            "&exclude=hourly,minutely&units=imperial&appid=03f72f8c02de3787c1292588066d019a";
          $.ajax({
            url: fiveDayURL,
            method: "GET",
          }).then(function (response) {
